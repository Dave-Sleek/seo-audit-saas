 ...
 * Phase 5 weighting.
 *
 * The weights intentionally prevent small metadata
 * problems from destroying an otherwise healthy page.
 */
 ...
 */
function normalizedCategoryWeight(
  category: SEOIssueCategory
): number {
  const total =
    Object.values(
...
export function analyzeHttpStatus(
  http: HTTPAnalysis
): SEOIssue[] {
  ...
  if (
    ...
    if (statusCode === 404) {
      ...
      issues.push({
        ...
        description:
          `The URL returned HTTP ${statusCode}.`,
        recommendation:
  ...
  if (statusCode >= 500) {
    issues.push({
      ...
      description:
        `The server returned HTTP ${statusCode}. Search engines and visitors may be unable to access this page.`,
      recommendation:
  ...
  if (redirectCount === 1) {
    issues.push({
      ...
      description:
        `This URL redirects to ${finalUrl}.`,
      recommendation:
  ...
  if (
    ...
    issues.push({
      ...
      description:
        `This URL requires ${redirectCount} redirects before reaching the final destination.`,
      recommendation:
  ...
  if (redirectCount > 3) {
    issues.push({
      ...
      description:
        `This URL requires ${redirectCount} redirects before reaching its final destination.`,
      recommendation:
  ...
  if (responseTimeMs >= 3000) {
    issues.push({
      ...
      description:
        `The page took ${responseTimeMs}ms to respond.`,
      recommendation:
...
export function analyzePage(
  ...
  let canonicalIsAbsolute =
    false;

  let canonicalMatchesPage:
    | boolean
    | null = null;
  ...
  let internalLinksCount =
    0;

  let externalLinksCount =
    0;
  ...
  let validJsonLdCount =
    0;

  let invalidJsonLdCount =
    0;
  ...
  if (!title) {
    issues.push({
      ...
      recommendation:
        "Add a unique and descriptive title for this page.",
    });
  } else if (
    titleLength < 30
  ) {
    issues.push({
      ...
      description:
        `The title contains only ${titleLength} characters.`,
      recommendation:
    ...
    issues.push({
      ...
      description:
        `The title contains ${titleLength} characters.`,
      recommendation:
  ...
  if (!canonicalUrl) {
    issues.push({
      ...
      description:
        "No canonical link was detected on this page.",
      recommendation:
    ...
    if (!canonicalIsAbsolute) {
      issues.push({
        ...
        description:
          "The canonical URL is not an absolute URL.",
        recommendation:
    ...
    if (
      ...
      issues.push({
        ...
        severity: "warning",
        title:
          "Canonical URL does not match the page",
        description:
  ...
  if (h1Count === 0) {
    ...
    issues.push({
      ...
      description:
        `This page contains ${h1Count} H1 headings.`,
      recommendation:
  ...
  if (
    ...
    issues.push({
      ...
      description:
        `${emptyHeadingCount} heading element(s) contain no meaningful text.`,
      recommendation:
        "Remove empty headings or give them meaningful text.",
    });
  }
  ...
  if (!hasViewport) {
    issues.push({
      ...
      description:
        "The page does not define a viewport meta tag.",
      recommendation:
  ...
  if (!hasLang) {
    issues.push({
      ...
      severity: "warning",
      title:
        "HTML language attribute is missing",
      description:
        "The document does not define a language on the HTML element.",
      recommendation:
        'Add an appropriate lang attribute, such as lang="en".',
    });
  }
  ...
  if (
    ...
    issues.push({
      ...
      description:
        `${imagesWithoutAlt} of ${imagesCount} images do not have alt text.`,
      recommendation:
  ...
  if (
    ...
    issues.push({
      ...
      severity:
        "notice",
      title:
        "Some image alt text is very long",
      description:
        `${imagesWithLongAlt} image(s) have alt text longer than 125 characters.`,
      recommendation:
  ...
  if (
    ...
    issues.push({
      ...
      description:
        `${invalidJsonLdCount} JSON-LD block(s) could not be parsed as valid JSON.`,
      recommendation:
  ...
  if (!hasOpenGraph) {
    ...
    if (!hasOgTitle) {
      issues.push({
        ...
        description:
          "The page does not define og:title.",
        recommendation:
          "Add an og:title value for social sharing.",
      });
    }
    ...
    if (!hasOgDescription) {
      issues.push({
        ...
        description:
          "The page does not define og:description.",
        recommendation:
          "Add an og:description value for social sharing.",
      });
    }
    ...
    if (!hasOgImage) {
      issues.push({
        ...
        description:
          "The page does not define og:image.",
        recommendation:
          "Add an og:image suitable for social sharing.",
      });
    }
  }
  ...
  if (!hasTwitterCard) {
    ...
    if (
      ...
      issues.push({
        ...
        severity: "notice",
        title:
          "Twitter/X title is missing",
        description:
          "The page does not define twitter:title.",
        recommendation:
          "Add twitter:title for better social previews.",
      });
    }
    ...
    if (
      ...
      issues.push({
        ...
        severity: "notice",
        title:
          "Twitter/X description is missing",
        description:
          "The page does not define twitter:description.",
        recommendation:
          "Add twitter:description for better social previews.",
      });
    }
    ...
    if (
      ...
      issues.push({
        ...
        severity: "notice",
        title:
          "Twitter/X image is missing",
        description:
          "The page does not define twitter:image.",
        recommendation:
          "Add twitter:image for richer social previews.",
      });
    }
  }
  ...
  if (
    ...
    issues.push({
      ...
      description:
        `Approximately ${wordCount} words were detected.`,
      recommendation:
  ...
  if (hasNoindex) {
    issues.push({
      ...
      description:
        "The robots meta tag contains a noindex directive.",
      recommendation:
  ...
  if (hasNofollow) {
    issues.push({
      ...
      description:
        "The robots meta tag contains a nofollow directive.",
      recommendation:
  ...
  if (hasNoarchive) {
    issues.push({
      ...
      severity: "notice",
      title:
        "Page contains a noarchive directive",
      description:
        "The robots meta tag contains a noarchive directive.",
      recommendation:
