...
export default function AuditReportClient({
  ...
  function handleExport() {
    ...
    // Expand all <details> so metadata lands in the printed PDF.
    document
    ...
    // Give the browser a tick to lay out the now-expanded content.
    window.setTimeout(() => {
      window.print();
    }, 50);
  }
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div className="min-w-0">
            <nav className="breadcrumbs mb-3 no-print" aria-label="Breadcrumb">
      ...
      {showUpgrade && (
        ...
        >
          <div
            className="stripe-panel w-full max-w-md"
            style={{ padding: 0 }}
          ...
          >
            <div className="p-6">
              ...
              <p
                ...
                style={{ color: "var(--text-muted)" }}
              >
                Upgrade to a paid plan to download this audit report
                as a branded PDF you can share with clients or your
                team. Free plans can still view the report online.
              </p>
